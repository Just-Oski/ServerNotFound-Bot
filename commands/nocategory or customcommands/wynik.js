...
module.exports = {
    ...
    async execute(client, msg, args, channel){
        ...
        .setTitle(datetime)
        .setColor('#9fc5e9')
        .addField('🥇 Miejsce 1', `<@706476079078047846> z 4 głosami ${brawa}`)
        .addField('🥈 Miejsce 2', `<@661162710871834635> z 3 głosami ${brawa}`)
        .addField('🥉 Miejsce 3', `<@510483080985968640>, <@718349577295757333> z 1 głosem ${brawa}`)
        ...
        .setTitle(datetime)
        .setColor('#bd0000')
        .addField('🥇 Miejsce 1', `<@441681052885581877> i <@505736913676664832> z 4 głosami ${brawa}`)
        .addField('🥈 Miejsce 2', `<@469463166766546954> z 3 głosami ${brawa}`)
        .addField('🥉 Miejsce 3', `<@772716365634076675> z 1 głosem ${brawa}`)
